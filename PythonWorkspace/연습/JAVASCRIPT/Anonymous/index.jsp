                    ...
                    <div class="portlet portlet-default">
                        ...
                        <div id="chat" class="panel-collapse collapse in">
                            <div class="portlet-body chat-widget" style="overflow-y: auto; width: auto; height: 300px;">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <p class="text-center text-muted small">2020년 12월 31일</p>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="media">
                                                <a href="#" class="pull-left">
                                                    <img src="images/icon.png" alt="" class="media-object img-circle">
                                                </a>
